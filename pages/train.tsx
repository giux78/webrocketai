...
const Train: NextPage = () => {
  ...
  return (
    <Layout2>
      {!isLoading && (
        <Box mt="2">
          <Text>Product Identifier: {identifier}</Text>
          <Input
            value={identifier}
            onChange={handleChange}
            placeholder="Example product111"
            size="lg"
          />
          <br />
          <br></br>
          <Text>Class name: {description}</Text>
          <Input
            value={description}
            onChange={handleChangeDesc}
            placeholder="Name of the class example: bag or shoes or ..."
            size="lg"
          />
